...
create_project -in_memory -part xcku5p-ffvb676-1-i
...
synth_design -top rowunit_cover -part xcku5p-ffvb676-1-i -flatten_hierarchy none


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef rowunit_cover.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file rowunit_cover_utilization_synth.rpt -pb rowunit_cover_utilization_synth.pb"
