...
HD_PWD='C:/Users/Sankar/Documents/GitHub/major-project-/row_process_oct15_pipelined/row_process_oct15_pipelined.runs/synth_2_using_xc7k70tfbv676-1'
cd "$HD_PWD"
...
EAStep vivado -log rowunit_cover.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rowunit_cover.tcl
