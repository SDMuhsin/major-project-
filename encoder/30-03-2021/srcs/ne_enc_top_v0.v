...
wire encstart;//connect wren of load fsm(inpintf) to start
...
//MAC network 0 //rst and clk are not used, as it is purely combinational logic
...
ne_outputinterface opintf(codevalid, codeTx, parityout_regin, parity_parloaden, msg_k, wren, txstart_regin, outclk, clk, rst);
