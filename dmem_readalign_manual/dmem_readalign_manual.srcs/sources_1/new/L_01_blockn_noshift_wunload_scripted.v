...
always@(*)begin
    case(unloadAddress)
       0: begin
              unloadMuxOut[0] = fifoOut[14][3];
              unloadMuxOut[1] = fifoOut[15][3];
              unloadMuxOut[2] = fifoOut[16][3];
              unloadMuxOut[3] = fifoOut[17][3];
              unloadMuxOut[4] = fifoOut[18][3];
              unloadMuxOut[5] = fifoOut[19][3];
              unloadMuxOut[6] = fifoOut[20][3];
              unloadMuxOut[7] = fifoOut[21][3];
              unloadMuxOut[8] = fifoOut[22][3];
              unloadMuxOut[9] = fifoOut[23][3];
              unloadMuxOut[10] = fifoOut[24][3];
              unloadMuxOut[11] = fifoOut[25][3];
              unloadMuxOut[12] = fifoOut[0][2];
              unloadMuxOut[13] = fifoOut[1][2];
              unloadMuxOut[14] = fifoOut[2][2];
              unloadMuxOut[15] = fifoOut[3][2];
              unloadMuxOut[16] = fifoOut[4][2];
              unloadMuxOut[17] = fifoOut[5][2];
              unloadMuxOut[18] = fifoOut[6][2];
              unloadMuxOut[19] = fifoOut[7][2];
              unloadMuxOut[20] = fifoOut[8][2];
              unloadMuxOut[21] = fifoOut[9][2];
              unloadMuxOut[22] = fifoOut[10][2];
              unloadMuxOut[23] = fifoOut[11][2];
              unloadMuxOut[24] = fifoOut[12][2];
              unloadMuxOut[25] = fifoOut[13][2];
              unloadMuxOut[26] = fifoOut[14][2];
              unloadMuxOut[27] = fifoOut[15][2];
              unloadMuxOut[28] = fifoOut[16][2];
              unloadMuxOut[29] = fifoOut[17][2];
              unloadMuxOut[30] = fifoOut[18][2];
              unloadMuxOut[31] = fifoOut[19][2];
       end
       1: begin
              unloadMuxOut[0] = fifoOut[14][3];
              unloadMuxOut[1] = fifoOut[15][3];
