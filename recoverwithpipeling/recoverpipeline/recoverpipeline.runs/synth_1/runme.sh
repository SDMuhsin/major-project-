...
HD_PWD='C:/Users/Sankar/Desktop/final proj/recovertest2/recoverpipeline/recoverpipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coverrecover.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coverrecover.tcl
