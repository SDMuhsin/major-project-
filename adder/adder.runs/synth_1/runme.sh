...
HD_PWD='C:/Users/sayed/Desktop/Programing/major project/major-project-/adder/adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addWCover.vds -m64 -mode batch -messageDb vivado.pb -notrace -source addWCover.tcl
