...
HD_PWD='C:/Users/sayed/Desktop/Programing/major project/major-project-/adder/adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addWCover.vdi -applog -m64 -messageDb vivado.pb -mode batch -source addWCover.tcl -notrace
