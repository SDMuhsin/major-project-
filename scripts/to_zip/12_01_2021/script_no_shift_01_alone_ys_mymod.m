...
filename = sprintf("./outputs/L01/LMem0To1_511_circ%d_ys_scripted.v",block-1);
fid = fopen (filename, "w");
fprintf(fid,sprintf("`timescale 1ns / 1ps\n"));
fprintf(fid,sprintf("module LMem0To1_511_circ%d_ys_scripted(\n",block-1));
fprintf(fid,sprintf("        muxOut,\n"));
fprintf(fid,sprintf("        ly0In,\n"));
