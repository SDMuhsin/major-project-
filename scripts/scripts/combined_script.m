...
if(shiftEn)
  filename = sprintf("./outputs/L10/Combined/LMem1To0_511_circ%d_combined_ys_yu_scripted_h1.txt",block-1);
...
fprintf(fid,sprintf("       1: begin // iteration_0_indicator = 0\n"));
fprintf(fid,sprintf("       case(rd_address_case)\n"));
