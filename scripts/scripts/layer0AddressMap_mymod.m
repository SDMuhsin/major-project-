...
function addressTable = layer0AddressMap_mymod (block)
...
stackedLUT = zeros(2,32);%(lyr,circ offset pairs)
j = 1;
...
offsets = stackedLUT(1:end, 2*block - 1:2*block)%(lyr,circ offset pairs)
circSize = 511;
