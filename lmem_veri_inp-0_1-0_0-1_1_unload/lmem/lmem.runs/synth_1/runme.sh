...
HD_PWD='C:/Users/sayed/Desktop/Programing/major project/major-project-/lmem/lmem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LMemReadWithFF.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LMemReadWithFF.tcl
