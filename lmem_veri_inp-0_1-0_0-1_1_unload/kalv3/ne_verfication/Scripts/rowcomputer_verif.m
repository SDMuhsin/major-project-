  ...
  # ---------------- #
    ...
    for slice = 1:1:max_slices
        ...
        #for row = 1:1:26
          ...
          #Ein_write(1:6)=func_conv_symbol2bin(E_in(1));
          #Ein_write(7:12)=func_conv_symbol2bin(E_in(2));
          #Ein_write(13:18)=func_conv_symbol2bin(E_in(3));
          #Ein_write(19:50)=E_in(4:35)+48;      
          ...
          #m1_write = func_conv_symbol2bin(m1);
          
          #m2_write = func_conv_symbol2bin(m2);
          
          #m1_psn_wr = func_conv_symbol2bin(m1_psn);
          
          #E_write = [m1_write,m2_write,m1_psn_wr,Q_sign+48];
