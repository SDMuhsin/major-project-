...
HD_PWD='C:/Users/sayed/Desktop/Programing/major project/major-project-/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log emsggen_cover.vds -m64 -mode batch -messageDb vivado.pb -notrace -source emsggen_cover.tcl
